...
class AppComponent extends Component {
    ...
    render() {
        ...
        var contentRow = e('div', {className: 'row', style: {paddingBottom:'1em'}},
                           e('div', {className: 'col-md-3', style:{height: '100%',overflowY:'scroll'}},
        ...
        return e('div', {}, pageNav, e('div', {style: {paddingTop:'1em', paddingRight:'15px', paddingLeft:'15px', marginRight:'auto', marginLeft:'auto'},className: 'fluid-container'}, app));
    }
}
